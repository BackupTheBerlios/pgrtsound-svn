...
/** Konstruktor
 * @param iCount iloœæ wejœæ
 * @param oCount iloœæ wyjœæ
 */
GtkModule::GtkModule(int iCount, int oCount) {
    ...
    //ustawienie wysokoœci modu³u na podstawie iloœci wejœæ i wyjœæ ale nie mniej niz 25 pix
...
/** On expose event
 * Rysowanie modu³u oraz jego wejœæ i wyjœæ
 */
